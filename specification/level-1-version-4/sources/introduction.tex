...
Additional example SED-ML files are available in Section~\ref{sec:app:examples}. Numerous complete examples with model files are available as COMBINE archives at \url{http://sed-ml.org/}.
