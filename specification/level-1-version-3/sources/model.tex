...
Each instance of the \concept{Model} class has the mandatory attributes \hyperref[sec:id]{\element{id}} and \hyperref[sec:model_source]{\code{source}}, and the optional attributes \hyperref[sec:name]{\element{name}}, \hyperref[sec:language]{\element{language}}, and \hyperref[sec:listOfChanges]{\element{changesModel}}.
