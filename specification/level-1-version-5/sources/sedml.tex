...
\begin{itemize}
	...
	\item \hyperref[class:style]{Style} (for the specification of plot element styles).
	\item \AlgorithmParameter (for the definition of global algorithm parameters).
\end{itemize}
