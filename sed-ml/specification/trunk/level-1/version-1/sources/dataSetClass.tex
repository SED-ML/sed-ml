...
\label{sec:label}
Each data set in a \hyperref[class:report]{Report} does have to carry an unambiguous \concept{label}. The label is then used to refer to a particular data set in a report for later use.
