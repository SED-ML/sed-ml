...
The \concept{\element{listOfDataSources}} contains one or more \SedDataSource elements that are then used in the remainder of the SED-ML document. \SedDataSource extracts chunks out of the data file provided by the outer \SedDataDescription element. 
