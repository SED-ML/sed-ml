...
The \concept{DataDescription} class introduces three attributes: the required attribute \token{id} and \token{source} and the optional attribute \token{name}. Additionally two elements are defined: \concept{dimensionDescription} and \concept{listOfDataSources}. 
