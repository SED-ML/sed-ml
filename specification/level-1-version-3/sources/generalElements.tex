...
\label{type:anyURI}
Type \code{anyURI} is used to reference models and data files, specify the language of models and the format of data files, for referencing implicit model variables and in annotations. For a description of the uses of \code{anyURI} see Section~\ref{sec:uriScheme}.
