...
\newcommand{\ColorKind} {\hyperref[type:colorKind]{ColorKind}\xspace}
\newcommand{\LineKind} {\hyperref[type:lineKind]{LineKind}\xspace}
\newcommand{\MarkerKind} {\hyperref[type:markerKind]{MarkerKind}\xspace}
\newcommand{\SIdRef} {\hyperref[type:sidref]{SIdRef}\xspace}
\newcommand{\SId} {\hyperref[type:sid]{SId}\xspace}
\newcommand{\ExperimentKind} {\hyperref[type:experimentKind]{ExperimentKind}\xspace}
\newcommand{\MappingKind} {\hyperref[type:mappingKind]{MappingKind}\xspace}
\newcommand{\ScaleKind} {\hyperref[type:scaleKind]{ScaleKind}\xspace}
