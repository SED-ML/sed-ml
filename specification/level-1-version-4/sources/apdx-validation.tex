...
\validRule{25803}{A \ParameterEstimationResultPlot object must have the required attribute \token{taskRef}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationResultPlot}.)}

\validRule{25804}{The value of the attribute \token{taskRef} of a \ParameterEstimationResultPlot object must be the identifier of an existing \Task object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationResultPlot}.)}
...
\validRule{25903}{A \WaterfallPlot object must have the required attribute \token{taskRef}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:waterfallPlot}.)}

\validRule{25904}{The value of the attribute \token{taskRef} of a \WaterfallPlot object must be the identifier of an existing \Task object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:waterfallPlot}.)}
...
\validRule{26003}{A \ParameterEstimationReport object must have the required attribute \token{taskRef}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationReport}.)}

\validRule{26004}{The value of the attribute \token{taskRef} of a \ParameterEstimationReport object must be the identifier of an existing \Task object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationReport}.)}
