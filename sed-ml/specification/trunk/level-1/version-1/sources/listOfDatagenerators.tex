...
In SED-ML, all variables/parameters/values that shall be used in the \hyperref[class:output]{Output} class need to be defined as a \hyperref[class:dataGenerator]{dataGenerator} beforehand. The container for those data generators is the \concept{listofDataGenerators} (\fig{listOfDataGenerators}). 
% Fig: DG
