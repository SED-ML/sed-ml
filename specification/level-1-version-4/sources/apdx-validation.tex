...
\validRule{20703}{A \Variable object may have the optional attributes \token{symbol}, \token{target}, \token{taskReference}, \token{modelReference}, \token{term}, \token{symbol2} and \token{target2}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:variable}.)}
...
\validRule{20708}{The value of the attribute \token{modelReference} of a \Variable object must be the identifier of an existing \Model object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:variable}.)}
...
\validRule{21303}{A \Task object must have the required attributes \token{modelReference} and \token{simulationReference}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:task}.)}

\validRule{21304}{The value of the attribute \token{modelReference} of a \Task object must be the identifier of an existing \Model object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:task}.)}
...
\validRule{22004}{The value of the attribute \token{yDataReference} of a \Curve object must be the identifier of an existing \DataGenerator object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:curve}.)}
...
\validRule{22103}{A \Surface object must have the required attributes \token{xDataReference}, \token{yDataReference}, \token{zDataReference} and \token{type}, and may have the optional attributes \token{style}, \token{logX}, \token{logY}, \token{logZ} and \token{order}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:surface}.)}
...
\validRule{22105}{The value of the attribute \token{yDataReference} of a \Surface object must be the identifier of an existing \DataGenerator object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:surface}.)}
...
\validRule{22803}{A \SetValue object must have the required attribute \token{modelReference}, and may have the optional attributes \token{range}, \token{symbol} and \token{target}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:setValue}.)}
...
\validRule{22805}{The value of the attribute \token{modelReference} of a \SetValue object must be the identifier of an existing \Model object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:setValue}.)}
...
\validRule{22903}{An \UniformRange object must have the required attributes \token{start}, \token{end} and \token{type}, and may have the optional attributes \token{numberOfPoints} and \token{numberOfSteps}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:uniformRange}.)}
...
\validRule{22908}{The attribute \token{numberOfSteps} on an \UniformRange must have a value of data type \token{integer}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:uniformRange}.)}
...
\validRule{24003}{A \ParameterEstimationTask object must have the required attribute \token{modelReference}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationTask}.)}
...
\validRule{24005}{The value of the attribute \token{modelReference} of a \ParameterEstimationTask object must be the identifier of an existing \Model object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:parameterEstimationTask}.)}
...
\validRule{24303}{An \AdjustableParameter object must have the required attribute \token{target}, and may have the optional attributes \token{initialValue} and \token{modelReference}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:adjustableParameter}.)}
...
\validRule{24307}{The value of the attribute \token{modelReference} of an \AdjustableParameter object must be the identifier of an existing \Model object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:adjustableParameter}.)}
...
\validRule{25703}{A \ShadedArea object must have the required attributes \token{yDataReferenceFrom} and \token{yDataReferenceTo}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:shadedArea}.)}

\validRule{25704}{The value of the attribute \token{yDataReferenceFrom} of a \ShadedArea object must be the identifier of an existing \DataGenerator object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:shadedArea}.)}

\validRule{25705}{The value of the attribute \token{yDataReferenceTo} of a \ShadedArea object must be the identifier of an existing \DataGenerator object defined in the document. (Reference: SED-ML Level~1 Version~4, Section \ref{class:shadedArea}.)}
