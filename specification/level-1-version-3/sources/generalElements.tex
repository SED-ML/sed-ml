...
Most primitive types in SED-ML are taken from the data types defined in XML Schema 1.0, including \code{string}, \code{boolean}, \code{int}, and \code{double}. A few other primitive types are defined by SED-ML itself: 
