...
\newcommand{\LoneVfive}{Level~1 Version~5\xspace}
\newcommand{\currentLV}{Level~1 Version~6\xspace}
\newcommand{\previousLV}{Level~1 Version~5\xspace}
...
\newcommand{\kisaoID} {\element{kisaoID}\xspace}
...
\newcommand{\NuMLSIdRef} {\hyperref[type:numlsidref]{NuMLSIdRef}\xspace}
\newcommand{\NuMLSId} {\hyperref[type:numlsid]{NuMLSId}\xspace}
...
\newcommand{\AbstractCurve} {\emph{\hyperref[class:abstractCurve]{\emph{AbstractCurve}}}\xspace}
\newcommand{\AbstractTask} {\emph{\hyperref[class:abstractTask]{\emph{AbstractTask}}}\xspace}
...
\newcommand{\Calculation} {\emph{\hyperref[class:calculation]{Calculation}}\xspace}
\newcommand{\Change} {\emph{\hyperref[class:change]{Change}}\xspace}
...
\newcommand{\DataReference} {\hyperref[sec:dataReference]{DataReference}\xspace}
\newcommand{\DataSet} {\hyperref[class:dataSet]{DataSet}\xspace}
\newcommand{\DataSource} {\hyperref[class:dataSource]{DataSource}\xspace}
\newcommand{\DimensionDescription} {\hyperref[class:dimensionDescription]{DimensionDescription}\xspace}
\newcommand{\ExperimentReference} {\hyperref[class:experimentReference]{ExperimentReference}\xspace}
...
\newcommand{\ListOfDataSources} {\hyperref[class:listOfDataSources]{ListOfDataSources}\xspace}
\newcommand{\ListOfDataDescriptions} {\hyperref[class:listOfDataDescriptions]{ListOfDataDescriptions}\xspace}
\newcommand{\ListOfDataGenerators} {\hyperref[class:listOfDataGenerators]{ListOfDataGenerators}\xspace}
\newcommand{\ListOfExperimentReferences} {\hyperref[class:listOfExperimentReferences]{ListOfExperimentReferences}\xspace}
...
\newcommand{\ListOfModels} {\hyperref[class:listOfModels]{ListOfModels}\xspace}
\newcommand{\ListOfOutputs} {\hyperref[class:listOfOutputs]{ListOfOutputs}\xspace}
\newcommand{\ListOfParameters} {\hyperref[class:listOfParameters]{ListOfParameters}\xspace}
\newcommand{\ListOfRanges} {\hyperref[class:listOfRanges]{ListOfRanges}\xspace}
\newcommand{\ListOfAppliedDimensions} {\hyperref[class:listOfAppliedDimensions]{ListOfAppliedDimensions}\xspace}
\newcommand{\ListOfSimulations} {\hyperref[class:listOfSimulations]{ListOfSimulations}\xspace}
\newcommand{\ListOfSlices} {\hyperref[class:listOfSlices]{ListOfSlices}\xspace}
\newcommand{\ListOfStyles} {\hyperref[class:listOfStyles]{ListOfStyles}\xspace}
\newcommand{\ListOfSubTasks} {\hyperref[class:listOfSubTasks]{ListOfSubTasks}\xspace}
...
\newcommand{\NonUniformTimeCourse} {\hyperref[class:nonUniformTimeCourse]{NonUniformTimeCourse}\xspace}
\newcommand{\Notes} {\hyperref[class:notes]{Notes}\xspace}
\newcommand{\Objective} {\emph{\hyperref[class:objective]{Objective}}\xspace}
\newcommand{\OneStep} {\hyperref[class:oneStep]{OneStep}\xspace}
\newcommand{\Output} {\hyperref[class:output]{Output}\xspace}
\newcommand{\ParameterEstimationReport} {\hyperref[class:parameterEstimationReport]{ParameterEstimationReport}\xspace}
\newcommand{\ParameterEstimationResultPlot} {\hyperref[class:parameterEstimationResultPlot]{ParameterEstimationResultPlot}\xspace}
...
\newcommand{\Range} {\emph{\hyperref[class:range]{Range}}\xspace}
\newcommand{\AppliedDimension} {\hyperref[class:appliedDimension]{AppliedDimension}\xspace}
...
\newcommand{\SEDBase} {\emph{\hyperref[class:sedBase]{\emph{SEDBase}}}\xspace}
\newcommand{\SedBase} {\emph{\hyperref[class:sedBase]{\emph{SEDBase}}}\xspace}
...
\newcommand{\Simulations} {\emph{\hyperref[class:simulation]{Simulations}}\xspace}
\newcommand{\Simulation} {\emph{\hyperref[class:simulation]{Simulation}}\xspace}
%\newcommand{\Simulation} {\hyperref[class:simulation]{Simulation}\xspace}
\newcommand{\Slice} {\hyperref[class:slice]{Slice}\xspace}
\newcommand{\SpecificTimeCourse} {\hyperref[class:specificTimeCourse]{SpecificTimeCourse}\xspace}
...
\newcommand{\TimeCourse} {\emph{\hyperref[class:timeCourse]{TimeCourse}}\xspace}
