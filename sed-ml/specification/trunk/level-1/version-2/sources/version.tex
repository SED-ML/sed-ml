...
The version attribute is \code{required} and its value is a \code{fixed} decimal. For SED-ML \LoneVtwo the value is set to \code{2}, as shown in the example in Listing~\ref{lst:sedmlRoot}.
