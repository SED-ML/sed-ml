...
\label{class:range}
The \concept{Range} class is abstract and exists solely as the base class for the different types of range, i.e. \hyperref[class:uniformRange]{UniformRange}, \hyperref[class:vectorRange]{VectorRange}, and\hyperref[class:functionalRange]{FunctionalRange} (\fig{range}). 
