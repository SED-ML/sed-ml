% Miase archive
\chapter{SED-ML archives}
\label{app:archive} 
A \concept{SED-ML archive} is a proposed  self-contained repository of all the resources necessary to run a simulation and display its output. It may be a convenient alternative if a model  source URI cannot be resolved,  or if an end-user is offline. 
