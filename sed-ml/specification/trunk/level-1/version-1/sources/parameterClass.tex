...
\label{sec:value}
Each \concept{parameter} defines a particular thing with a exactly one fixed \concept{value}. The \code{value} attribute of XML data type \code{Double} is required for each \code{parameter} element. 
