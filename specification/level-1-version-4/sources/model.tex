...
Additional \hyperref[class:parameter]{Parameters} via the optional child \ListOfParameters. Such \hyperref[class:parameter]{Parameters} are thereafter referred to by their \hyperref[sec:id]{\element{id}}. 
...
listOfParameters$^{o}$ & \refpage{class:listOfParameters}\\
