...
% The folowing was in the old draft, but I think we can remove it.
% ------------------------------------------------------------------
%\subsubsection{\element{double}}
%\label{type:double}
%
...
% The following must be corrected and updated
% -->
\subsubsection{\element{ColorType}}
\label{type:colorType}
...
\subsubsection{\element{MarkerType}}
...
\subsubsection{\element{LineType}}
\label{type:lineType}
...
\sedfig[width=0.8\textwidth]{images/uml/sedBase}{The SEDBase class}{fig:sedBase}
...
\label{sec:id}
\hl{TODO describe new optional id on SED-base, fix the other id references in the document}
