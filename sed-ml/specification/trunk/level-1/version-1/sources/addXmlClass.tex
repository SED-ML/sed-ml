...
\label{class:addXml}
The \concept{AddXML} class specifies a snippet of XML that is to be added as child of the specified XPath \hyperref[sec:target]{target} (see again section \ref{sec:target} on page \refpage{sec:target}). 
