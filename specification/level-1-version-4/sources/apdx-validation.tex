...
\validRule{20703}{A \Variable object may have the optional attributes \token{symbol}, \token{target}, \token{taskReference}, \token{model\-Reference}, \token{term}, \token{symbol2} and \token{target2}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:variable}.)}
...
\validRule{20712}{Apart from the general notes and annotations subobjects permitted on all SED-ML objects, a \ListOfAppliedDimensions container object may only contain \AppliedDimension objects. (Reference: SED-ML Level~1 Version~4, Section \ref{class:listOfAppliedDimensions}.)}

\validRule{20713}{A \ListOfAppliedDimensions object may have the optional SED-ML Level~1 attributes \token{id}, \token{name}, and \token{metaid}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:listOfAppliedDimensions}.)}
...
\validRule{21008}{The attribute \token{number\-Of\-Steps} on an \UniformTimeCourse must have a value of data type \token{integer}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:uniformTimeCourse}.)}
...
\subsubsection*{Rules for \Plot2D objects}
...
\subsubsection*{Rules for \Plot3D objects}
...
\validRule{22907}{The attribute \token{numberOfPoints} on an \UniformRange must have a value of data type \token{integer}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:uniformRange}.)}

\validRule{22908}{The attribute \token{number\-Of\-Steps} on an \UniformRange must have a value of data type \token{integer}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:uniformRange}.)}
