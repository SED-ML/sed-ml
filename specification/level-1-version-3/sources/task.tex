...
The \concept{\element{listOfRanges}} defines the \hyperref[class:range]{ranges} used in the \hyperref[class:repeatedTask]{repeatedTask}. The \concept{\element{listOfRanges}} contains one or more \hyperref[class:range]{Ranges}.
