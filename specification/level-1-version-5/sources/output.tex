...
The \Output class describes how the results of a simulation are presented (\fig{output}). The available output classes are \Plot, \Report, \ParameterEstimationReport, and \Figure, \changed{or the \Output class itself can be used directly if none of its subclasses apply}. The data used in an \Output is provided via the \DataGenerator class.
