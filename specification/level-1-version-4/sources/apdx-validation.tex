...
\validRule{20709}{Apart from the general notes and annotations subobjects permitted on all SED-ML objects, a \ListOfAppliedDimensions container object may only contain \AppliedDimension objects. (Reference: SED-ML Level~1 Version~4, Section \ref{class:listOfAppliedDimensions}.)}

\validRule{20710}{A \ListOfAppliedDimensions object may have the optional SED-ML Level~1 attributes \token{id}, \token{name}, and \token{metaid}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:listOfAppliedDimensions}.)}
...
\validRule{25403}{A \Fill object must have the required attribute \token{color}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:fill}.)}
...
\validRule{25601}{An \AppliedDimension object may have the optional SED-ML Level~1 attributes \token{id}, \token{name}, and \token{metaid}. (Reference: SED-ML Level~1 Version~4, Section~\ref{class:sedBase}.)}

\validRule{25602}{An \AppliedDimension object may have the optional SED-ML Level~1 subobjects for notes and annotations. (Reference: SED-ML Level~1 Version~4, Section~\ref{class:sedBase}.)}

\validRule{25603}{An \AppliedDimension object may have the optional attributes \token{target} and \token{dimensionTarget}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}

\validRule{25604}{The value of the attribute \token{target} of an \AppliedDimension object must be the identifier of an existing \ object defined in the enclosing \Model object. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}

\validRule{25605}{The value of the attribute \token{dimensionTarget} of an \AppliedDimension object must be the identifier of an existing \ object defined in the enclosing \Model object. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}
...
\validRule{25703}{A \DataRange object must have the required attribute \token{sourceReference}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:dataRange}.)}

\validRule{25704}{The value of the attribute \token{sourceReference} of a \DataRange object must be the identifier of an existing \ object defined in the enclosing \Model object. (Reference: SED-ML Level~1 Version~4, Section \ref{class:dataRange}.)}
