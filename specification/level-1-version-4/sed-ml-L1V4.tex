...
This section describes the major components of SED-ML. \changed{Each subsection includes UML diagrams for the relevant classes.}  Example simulation experiments are provided in Appendix~\ref{app:examples}. Complete examples with model files are available at \url{https://sed-ml.org/}.%, and the XML Schema is listed in Appendix~\ref{app:schema}.
...
\item{Federal Ministry of Education and Research (BMBF, Germany) within the research network Systems Medicine of the Liver (grant number 031L0054) by the German Research Foundation within the Research Unit Programme FOR 5151 by grant number 436883643. (MK)}
\end{itemize}
