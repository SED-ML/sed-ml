...
\newcommand{\currentLV}{Level~1 Version~5\xspace}
\newcommand{\previousLV}{Level~1 Version~4\xspace}
...
\newcommand{\AnalyticOutput} {\hyperref[class:analyticOutput]{AnalyticOutput}\xspace}
