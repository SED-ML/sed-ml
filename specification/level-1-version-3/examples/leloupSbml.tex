...
\sedfigX[scale=0.8]{examples/leloupSBML}{The simulation result gained from the simulation description given in \lst{leloup1}}{fig:leloupExample}

\myXmlImport{LeLoup Model Simulation Description in SED-ML}{lst:leloup1}{examples/leloupSbml.xml}
