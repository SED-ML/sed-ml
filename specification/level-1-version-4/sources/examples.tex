...
This example lists the SED-ML for the example in the introduction (Section~\ref{motivation:example}).  \changed{It illustrates the use of a \DependentVariable to calculate the maximum value of a vector with the KiSAO term for 'maximum' (\val{KISAO:0000828}) as the \element{term}.  This document can be found at \url{http://sed-ml.org/examples/L1V3/L1V3_repressilator/repressilator.xml}, and an OMEX version at \url{http://sed-ml.org/examples/L1V3/L1V3_repressilator.omex}.}
