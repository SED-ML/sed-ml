 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.biomodels.net/sed-ml}dataGenerator" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "listOfDataGenerators")
public class ListOfDataGenerators {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dataGenerators property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDataGenerators().add(newItem);
     * </pre>
     * 
     * 
     * <p>
