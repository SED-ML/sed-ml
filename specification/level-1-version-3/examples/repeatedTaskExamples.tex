\section{Simulation Experiments with \concept{repeatedTask}s}
...
\sedfigX[scale=0.6]{examples/v3-example1-repeated-steady-scan-oscli}{The simulation result gained from the simulation description given in \lst{repeated1}}{fig:figrepeated1}
...
\sedfigX[scale=0.6]{examples/v3-example2-oscli-nested-pulse}{The simulation result gained from the simulation description given in \lst{repeated2}}{fig:figrepeated2}
...
\sedfigX[scale=0.6]{examples/v3-example3-repeated-stochastic-runs}{The simulation result gained from the simulation description given in \lst{repeated3}}{fig:figrepeated3}
...
\sedfigX[scale=0.6]{examples/v3-example4-repeated-scan-oscli}{The simulation result gained from the simulation description given in \lst{repeated4}}{fig:figrepeated4}
...
\sedfigX[scale=0.6]{examples/v3-example5-boris-2d-scan}{The simulation result gained from the simulation description given in \lst{repeated5}}{fig:figrepeated5}
