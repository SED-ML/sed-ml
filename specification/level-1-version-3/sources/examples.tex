...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{lorenz-sbml} with SED-ML webtools.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        ...
        \caption{The simulation result gained from the simulation description given in \lst{lorenz-sbml} with tellurium.}
    \end{minipage}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{lorenz-cellml} with SED-ML webtools.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{examples/lorenz-cellml/results/opencor/plot1}
        \caption{The simulation result gained from the simulation description given in \lst{lorenz-cellml} with OpenCOR.}
    \end{minipage}
