...
Note that \element{Parameter} and \element{Variable} are subclasses of \emph{SEDBase}; the respective inheritance connections are not shown in the figure.}{fig:sedDG}
