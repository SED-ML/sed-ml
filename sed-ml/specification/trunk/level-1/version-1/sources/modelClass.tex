...
% Fig: sed model
\sedfig[width=0.9\textwidth]{listOfChanges}{The SED-ML Model class}{fig:sedModel}
%
...
The \element{language} attribute is optional for the XML representation of a SED-ML file. If it is not explicitely defined otherwise in the SED-ML file, the default value for the \element{language} attribute is \code{urn:sedml:language:xml}, referring to any XML based model representation. 
