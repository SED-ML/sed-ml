...
The \concept{listOfTasks} container contains the defined tasks for the simulation experiment (\fig{listOfTasks}).
%
...
%
\begin{myXmlLst}{The SED-ML \code{listOfTasks} element, defining one task}{lst:listOfTask}
<listOfTasks>
