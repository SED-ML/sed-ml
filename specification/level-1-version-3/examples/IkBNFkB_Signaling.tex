...
\sedfig[width=0.8\textwidth]{examples/IkBNFkB_Signaling}{The simulation result gained from the simulation description given in \lst{ikappab}}{fig:ikappabExample}
