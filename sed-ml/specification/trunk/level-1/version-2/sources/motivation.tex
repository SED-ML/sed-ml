...
To demonstrate how a simulation experiment can be described simply and effectively, we make use of a rather simple, though famous, model that displays rich and variable behaviors. The simulation example is taken from \citet{Waltemath:2011}. 
