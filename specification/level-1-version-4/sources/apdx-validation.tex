...
\validRule{25601}{A \AppliedDimension object may have the optional SED-ML Level~1 attributes \token{id}, \token{name}, and \token{metaid}. (Reference: SED-ML Level~1 Version~4, Section~\ref{class:sedBase}.)}

\validRule{25602}{A \AppliedDimension object may have the optional SED-ML Level~1 subobjects for notes and annotations. (Reference: SED-ML Level~1 Version~4, Section~\ref{class:sedBase}.)}

\validRule{25603}{A \AppliedDimension object may have the optional attributes \token{target} and \token{dimensionTarget}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}

\validRule{25604}{The value of the attribute \token{target} of a \AppliedDimension object must be the identifier of an existing \ object defined in the enclosing \Model object. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}

\validRule{25605}{The value of the attribute \token{dimensionTarget} of a \AppliedDimension object must be the identifier of an existing \ object defined in the enclosing \Model object. (Reference: SED-ML Level~1 Version~4, Section \ref{class:appliedDimension}.)}
