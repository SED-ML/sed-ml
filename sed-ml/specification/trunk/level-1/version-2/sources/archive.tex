% Miase archive
\chapter{SED-ML archive}
\label{app:archive} 
A \concept{SED-ML archive} is self-contained repository of all the resources necessary to run a simulation and display its output. It is a convenient alternative if a model source URI cannot be resolved,  or if an end-user is offline. 
