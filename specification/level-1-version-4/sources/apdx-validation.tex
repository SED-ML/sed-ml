...
\subsubsection*{Rules for \ExperimentRef objects}
...
\validRule{24403}{An \ExperimentRef object must have the required attribute \token{experimentId}. (Reference: SED-ML Level~1 Version~4, Section \ref{class:experimentRef}.)}

\validRule{24404}{The value of the \element{experiment} attribute of a \ExperimentRef must be the identifier of an existing \FitExperiment child of the parent \ParameterEstimationTask.  (Reference: SED-ML Level~1 Version~4, Section \ref{class:variable})}
