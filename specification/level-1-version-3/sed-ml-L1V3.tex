...
All specification examples listed below are available as \hyperref[sec:archive]{Combine Archives} under the \code{*.omex} file name listed for the respective examples from \url{http://sed-ml.org/}. 
