...
This section describes the major components of SED-ML. Each subsection includes UML diagrams for the relevant classes.  Example simulation experiments are provided in Appendix~\ref{app:examples}. Complete examples with model files are available at \url{https://sed-ml.org/}.%, and the XML Schema is listed in Appendix~\ref{app:schema}.
