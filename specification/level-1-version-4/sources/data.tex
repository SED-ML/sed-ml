...
\changed{The \element{id} may also be used as the \element{sourceRef} of a \DataRange, and as the \element{dataSource} or \element{pointWeight} of a \FitMapping.  These referenced data may be multidimensional.}
