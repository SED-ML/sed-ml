...
All the operations listed above only operate on \emph{singular} values. However, as one of SED-ML's aim is to provide post processing on the results of simulation experiments, we need to enhance this basic set of operations by some aggregate functions. 
...
%
\begin{myXmlLst}{Example for the use of the MathML \code{sum} function.}{lst:productFunction}
<apply>
