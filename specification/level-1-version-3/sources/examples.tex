...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{Loaded and plotted data from the simulation description given in \lst{reading-data-csv}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{examples/placeholder}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result from the simulation description given in \lst{plotting-data}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{examples/placeholder}
