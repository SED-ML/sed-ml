...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\section{Example simulation experiment (\code{L1V3\_repressilator.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result from the simulation description given in \lst{plotting-data-numl}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{Time course parameter scan (\code{L1V3\_repeated-scan-oscli.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{repeated-scan-oscli}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{Steady state parameter scan (\code{L1V3\_repeated-steady-scan-oscli.omex})}
...
\begin{figure}[ht!]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result from the simulation description given in \lst{repeated-steady-scan-oscli}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{Stochastic simulation (\code{L1V3\_repeated-stochastic-runs.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result from the simulation description given in \lst{repeated-stochastic-runs}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{Simulation perturbation (\code{L1V3\_oscli-nested-pulse.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result from the simulation description given in \lst{oscli-nested-pulse}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{2D steady state parameter scan (\code{L1V3\_parameter-scan-2d.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{parameter-scan-2d}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\subsection{Van der Pol Model in SBML (\code{L1V3\_vanderpol-sbml.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{vanderpol-sbml}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\myXmlImport{LeLoup Model Simulation Description in SED-ML}{lst:vanderpol-sbml}{examples/vanderpol-sbml/vanderpol.xml}

\subsection{Van der Pol Model in CellML (\code{L1V3\_vanderpol-cellml.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{vanderpol-cellml}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
\myXmlImport{Van der Pol Model Simulation Description in SED-ML}{lst:vanderpol-cellml}{examples/vanderpol-cellml/vanderpol.xml}
...
%        \caption{The simulation result gained from the simulation description given in \lst{lorenz-sbml}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
%    \end{minipage}\hfill
%    \begin{minipage}{0.47\textwidth}
%        \centering
...
%        \caption{The simulation result gained from the simulation description given in \lst{lorenz-cellml}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
%    \end{minipage}\hfill
%    \begin{minipage}{0.47\textwidth}
%        \centering
...
% ~~~ LE LOUP (SBML) ~~~
\subsection{Le Loup Model(\code{L1V3\_leloup-sbml.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{leloup-sbml}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
...
% ~~~ IKAPPAB ~~~
\subsection{IkappaB Signaling (\code{L1V3\_ikkapab.omex})}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.47\textwidth}
        ...
        \caption{The simulation result gained from the simulation description given in \lst{ikappab}. Simulated with SED-ML web tools \citep{bergmann2017sed}.}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
